    ...
    return (
        <div className="w-full max-w-md p-4 my-24 rounded-md shadow sm:p-8 bg-blue-700 mx-auto text-white dark:bg-gray-900 dark:text-gray-100">
            ...
            <div className="my-6 space-y-4">
                ...
                <button aria-label="Login with Twitter" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-400 focus:ring-violet-400">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
            ...
            <form noValidate="" action="" className="space-y-8 ng-untouched ng-pristine ng-valid">
                ...
                <button type="button" className="w-full px-8 py-3 font-semibold rounded-md bg-blue-300  hover:bg-blue-400  dark:bg-blue-300  dark:text-gray-900">Log in</button>
            </form>
        </div>
    );
};
